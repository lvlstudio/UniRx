...
namespace UniRx
{
    public static partial class AsyncOperationExtensions
    {
        ...
        /// </summary>
        public static Rx.IObservable<AsyncOperation> AsObservable(this AsyncOperation asyncOperation, IProgress<float> progress = null)
        {
        ...
        public static Rx.IObservable<T> AsAsyncOperationObservable<T>(this T asyncOperation, IProgress<float> progress = null)
        ...
        static IEnumerator AsObservableCore<T>(T asyncOperation, Rx.IObserver<T> observer, IProgress<float> reportProgress, CancellationToken cancel)
            where T : AsyncOperation
        {
